/**
 * @file DashboradStats.jsx
 * @description KPI stat row for the admin dashboard home — users, revenue, orders.
 * @component DashboradStats
 */
        ...
        return (
          ...
          >
            <div>
              ...
              <p className="text-[20px] font-semibold text-gray-900 mt-1">{item.value}</p>
            </div>
