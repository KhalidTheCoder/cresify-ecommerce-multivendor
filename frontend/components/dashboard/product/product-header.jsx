/**
 * @file product-header.jsx
 * @description Section header for the vendor products area with title and add-product button.
      ...
      <div className="flex justify-between">
        ...
        <div>
          ...
          <Link
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-[#AA4BF5] to-[#FF7C74] text-white px-5 py-3 rounded-lg text-sm shadow-md"
          >
