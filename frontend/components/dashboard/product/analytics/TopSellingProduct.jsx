/**
 * @file TopSellingProduct.jsx
 * @description Table of top-selling products ranked by units sold.
...
export default function TopSellingProduct() {
  return (
    <div className="bg-white rounded-[14px] p-6 border border-[#EEEAF5] shadow-[0_4px_22px_rgba(0,0,0,0.05)]">
      <h2 className="text-lg font-semibold text-[#1D1D1F] mb-6">Top Selling Product</h2>
