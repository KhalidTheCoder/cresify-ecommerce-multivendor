/**
 * @file CheckoutSection.jsx
 * @description Checkout form covering shipping address, order summary, and Stripe card input.
    ...
    <section className="w-full bg-[#F7F7FA] py-10 px-4">
      <div className="max-w-[1200px] mx-auto grid gap-6 lg:grid-cols-[minmax(0,1.7fr)_minmax(0,0.9fr)]">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-[16px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] px-6 py-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-[14px] font-semibold text-[#222]">Shipping Details</h3>
            </div>
            ...
            <div className="space-y-4 text-[12px]">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  <label className="block text-[#666] mb-[4px]">Telephone*</label>
                  <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
                    <MapPin className="h-4 w-4 text-[#C2B7EB]" />
                    <span className="flex-1 text-[12px] text-[#B4B4C0]">Select Country</span>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
                    <MapPin className="h-4 w-4 text-[#C2B7EB]" />
                    <span className="flex-1 text-[12px] text-[#B4B4C0]">Select city</span>
                    <ChevronDown className="h-4 w-4 text-[#B4B4C0]" />
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-[16px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] px-6 py-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-[14px] font-semibold text-[#222]">Payment Method</h3>
            </div>
              ...
              <div className="rounded-[10px] bg-gradient-to-r from-[#9838E1] to-[#F68E44] p-[1px]">
                <div className="flex items-center justify-between rounded-[9px] bg-[#FAF7FF] px-3 py-[9px]">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-[12px] font-semibold text-[#4A4A4A]">Credit/Debit Card</p>
            ...
            <div className="space-y-3 text-[12px]">
              {/* Card number */}
              <div>
                <label className="block text-[#666] mb-[4px]">Card number*</label>
                <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label className="block text-[#666] mb-[4px]">Expiration Date*</label>
                  <input
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label className="block text-[#666] mb-[4px]">Name of the Holder*</label>
                  <input
                    className="w-full rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] text-[12px] outline-none placeholder:text-[#B4B4C0]"
              ...
              <div className="mt-3 space-y-2">
                <div className="flex items-start gap-2 text-[11px] text-[#7F7F90]">
                  ...
                  <p>
                    ...
                    <span className="text-[#9B51E0]">256-bit SSL encryption</span>.
                  </p>
                </div>
        ...
        <aside className="bg-white rounded-[16px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] px-6 py-5 h-fit">
          <h3 className="text-[14px] font-semibold text-[#222] mb-4">Order Summary</h3>
          ...
          <div className="space-y-3 text-[12px] mb-4">
            ...
            <div className="flex items-center justify-between gap-3 pb-3 border-b border-[#F1ECF8]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[12px] font-semibold text-[#333]">Handmade Ceramic Vase</p>
            ...
            <div className="flex items-center justify-between gap-3 pb-3 border-b border-[#F1ECF8]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[12px] font-semibold text-[#333]">Organic Product</p>
                  <p className="text-[11px] text-[#9B9B9B]">Quantity: 2</p>
                </div>
              </div>
              <p className="text-[12px] font-semibold text-[#F78D25]">$45.00</p>
          ...
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <p className="text-[11px] text-[#777]">100% secure and encrypted payment.</p>
          </div>

          {/* Payment methods */}
          <div className="flex border-t border-[#F1ECF8]  justify-center w-full">
            <div className="pt-3">
              <p className="text-[11px] text-[#999] mb-2">Accepted payment methods</p>
