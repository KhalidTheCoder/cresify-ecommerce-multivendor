 ...
 * @description Horizontally scrollable grid of featured product cards.
    ...
    return (
      <section className="w-full py-20 px-4 md:px-10">
        <div className="max-w-[1350px] mx-auto">
          <h2 className="text-[36px] font-bold text-center mb-2">{t('title')}</h2>
  ...
  return (
    <section className="w-full py-20 px-4 md:px-10">
      <div className="max-w-[1350px] mx-auto">
        ...
        {/* Subtext */}
        <p className="text-center font-bold text-[#AC65EE] text-[15px] mb-12">{t('description')}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {displayProducts.map((product) => {
            ...
            return (
              <Link href={`/product-details/${product._id}`} key={product._id} className="block">
                <div
                  className="
                  ...
                  <div className="flex items-center gap-1 mb-3">
                    {[...Array(5)].map((_, i) => (
                      <AiFillStar
                        key={i}
                        className={`text-[16px] ${
                          i < Math.floor(product.rating || 0) ? 'text-[#FFA534]' : 'text-[#E0E0E0]'
                        }`}
                      />
                    ))}
