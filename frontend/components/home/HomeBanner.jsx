/**
 * @file HomeBanner.jsx
 * @description Full-viewport hero with headline, CTA, and animated gradient background.
      ...
      >
        ...
        <div className="w-full lg:w-[45%]">
          ...
          >
            ...
            <Link href={`/marketplace${buildQueryString()}`} className="w-full sm:w-auto">
              <button
                disabled={isLoading}
                className="
            ...
            <Link href={`/services${buildQueryString()}`} className="w-full sm:w-auto">
              <button
                disabled={isLoading}
                className="
