/**
 * @file AboutCresify.jsx
 * @description Brand story and value proposition section on the homepage.
 * @component AboutCresify
 */
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-6 mb-10">
            ...
            <div className="bg-white rounded-[16px] shadow-[0px_4px_18px_rgba(0,0,0,0.10)] p-6 w-[160px]">
              ...
              <h3 className="text-[20px] font-semibold text-[#1E1E1E] mb-1">10,000+</h3>
              <p className="text-[13px] text-[#7A5FA6]">{t('stats.active_sellers')}</p>
            </div>
            ...
            <div className="bg-white rounded-[16px] shadow-[0px_4px_18px_rgba(0,0,0,0.10)] p-6 w-[160px]">
              ...
              <h3 className="text-[20px] font-semibold text-[#1E1E1E] mb-1">50,000+</h3>
              <p className="text-[13px] text-[#7A5FA6]">{t('stats.happy_customers')}</p>
            </div>
          </div>
