/**
 * @file SearchHero.jsx
 * @description Full-width hero search bar with category filter for the marketplace page.
  ...
  return (
    <section className="w-full py-20 text-center">
      <div className="max-w-[900px] mx-auto px-6">
        ...
        {/* Subheading */}
        <p className="text-[15px] text-[#8F63E8] font-medium mb-10">{t('search_hero.subtitle')}</p>
