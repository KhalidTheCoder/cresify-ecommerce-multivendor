/**
 * @file FeaturedStores.jsx
 * @description Grid of featured vendor stores shown on the marketplace page.
  ...
  return (
    <section className="w-full py-16">
      <div className="max-w-[1360px] mx-auto">
        {/* Heading */}
        <h2 className="text-[32px] font-bold text-center mb-2">Featured Stores</h2>
          ...
          >
            {stores.map((s) => (
              <SwiperSlide key={s.id}>
                <div
                  className="bg-white rounded-[18px] border border-[#EEE9F6]
