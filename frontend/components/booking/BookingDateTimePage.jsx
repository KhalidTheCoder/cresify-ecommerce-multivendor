/**
 * @file BookingDateTimePage.jsx
 * @description Date and time slot picker for the first step of the service booking flow.
...
function BookingDateTimeContentPage() {
  ...
  const { data: timeslotsResponse, isLoading: timeslotsLoading } = useGetProviderTimeslotsQuery(
    selectedDateId,
    {
      ...
      <div className="mx-auto max-w-[1250px] grid gap-8">
        ...
        <div className="rounded-[20px] border border-[#ECE6F7] bg-white px-8 py-6 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
          ...
          <div className="mb-4 flex items-center justify-between">
            <p className="text-[13px] font-medium text-[#111827]">Select Date & Time</p>

            <div className="flex items-center">
              <span className="text-[14px] font-semibold text-[#111827]">{monthLabel}</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between mb-2">
              <p className="text-[13px] font-medium text-[#111827]">Available Time Slots</p>
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  ...
                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-800">
                      <span className="font-semibold">Note:</span> Payment will be collected at the
                      time of service.
                    </p>
                  </div>
                </div>
