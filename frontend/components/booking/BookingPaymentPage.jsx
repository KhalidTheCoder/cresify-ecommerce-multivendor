/**
 * @file BookingPaymentPage.jsx
 * @description Booking review and payment step with full booking summary and Stripe integration.
 * @component BookingPaymentPage
 */

'use client';

import { User, Mail, Phone, MapPin, CreditCard, CheckCircle2, Receipt } from 'lucide-react';
    ...
    <section className="w-full bg-[#F7F7FA] py-10 px-4">
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8">
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 px-3 py-[10px] border border-[#E3E1ED] rounded-[10px]">
                  ...
                  <input className="flex-1 outline-none text-[13px]" placeholder="+880" />
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-[18px] border border-[#E9E5F4] shadow-[0_10px_30px_rgba(15,23,42,0.06)] p-6">
            ...
            <div className="flex items-center justify-between px-4 py-3 rounded-[12px] border border-[#D7CBF5] bg-[#F9F6FF] mb-4 cursor-pointer">
              <div>
                <p className="text-[12px] font-semibold text-[#333]">Credit/Debit Card</p>
                <p className="text-[10px] text-[#888]">Visa, Mastercard, American Express</p>
              </div>
            ...
            <div className="flex items-center justify-between px-4 py-3 rounded-[12px] border border-[#E3E1ED] mb-4 cursor-pointer">
              <p className="text-[12px] text-[#333] font-medium">Pay after service</p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-3">
              <div className="space-y-1">
                <label className="text-[12px] text-[#6A6A6A]">Expiration Date*</label>
                <input
            ...
            {/* Holder Name */}
            <div className="space-y-1 mb-4">
              <label className="text-[12px] text-[#6A6A6A]">Name of the Holder*</label>
              <input
                className="w-full px-3 py-[10px] border border-[#E3E1ED] rounded-[10px] outline-none text-[13px]"
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-[11px] text-[#777]">Your payment is protected by Stripe.</p>
            </div>
        ...
        <div className="w-full space-y-6">
          ...
          <aside className="bg-white rounded-[18px] border border-[#E9E5F4] shadow-[0_10px_30px_rgba(15,23,42,0.06)] px-6 py-5">
            <h3 className="text-[14px] font-semibold text-[#1B1B1B] mb-4">Customer Information</h3>
          ...
          <aside className="bg-white rounded-[18px] border border-[#E9E5F4] shadow-[0_10px_30px_rgba(15,23,42,0.06)] px-6 py-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-[14px] font-semibold text-[#1B1B1B]">Payment Details</h3>
