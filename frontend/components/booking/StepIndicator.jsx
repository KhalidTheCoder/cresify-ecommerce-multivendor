 ...
 * @description Reusable step indicator component showing active, completed, and upcoming steps.
  ...
  return (
    <div className="w-full flex items-center justify-center py-6">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Label */}
        <span className="text-[14px] font-medium text-[#222]">Select Date & Time</span>
      </div>
      ...
      <div className="flex items-center gap-2 opacity-80">
        ...
        {/* Label */}
        <span className="text-[14px] font-medium">Booking Details & Payment</span>
      </div>
    </div>
  );
}
