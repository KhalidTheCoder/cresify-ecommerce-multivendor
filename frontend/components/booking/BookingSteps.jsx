/**
 * @file BookingSteps.jsx
 * @description Progress indicator component for the three-step service booking process.
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-2">
            <div
              ...
              `}
            >
              <Calendar size={18} className={date ? 'text-white' : 'text-gray-400'} />
            </div>
            ...
            <div>
              ...
              {datesLoading && <p className="text-xs text-gray-500 mt-1">Loading dates...</p>}
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <span
                className={`text-[14px] font-medium ${timeSlot?.data?.length > 0 ? 'text-[#1B1B1B]' : 'text-[#7A7A7A]'}`}
              >
