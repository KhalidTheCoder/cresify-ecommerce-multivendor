 ...
 * @description Saved payment methods manager in the user profile.
    ...
    <section className="w-full bg-white rounded-lg px-4 py-10">
      <div className="mx-auto w-full max-w-[880px]">
        ...
        <div className="mb-5 flex items-center justify-between">
          <h2 className="text-[20px] font-semibold text-[#161616]">Payment Methods</h2>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-[2px]">
                    <p className="text-[13px] font-semibold text-[#151515]">
                      {card.brand} <span className="tracking-[0.18em]">****{card.last4}</span>
                    </p>
                    <p className="text-[11px] text-[#8E8E95]">Expires {card.expires}</p>
                  </div>
