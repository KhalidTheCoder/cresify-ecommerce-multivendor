/**
 * @file Wishlist.jsx
 * @description Saved wishlist items with add-to-cart and remove actions.
 * @component Wishlist
 */

'use client';

import { useGetWishListQuery, useRemoveFromWishListMutation } from '@/feature/customer/WishlistApi';
...
export default function Wishlist() {
  ...
  if (!userId) {
    return <p className="text-center text-lg py-10">Login to view your wishlist</p>;
  }
    ...
    <section className="w-full bg-white rounded-lg px-4 pb-10">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="flex justify-between items-center mb-6 pt-4">
          ...
          <p className="text-[13px] text-[#9838E1] cursor-pointer">{items.length} Items</p>
        </div>
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-4">
                <p className="text-[18px] font-semibold text-[#F78D25]">${item.product?.price}</p>
