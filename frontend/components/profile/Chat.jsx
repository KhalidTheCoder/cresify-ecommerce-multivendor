/**
 * @file Chat.jsx
 * @description Real-time chat interface with conversation list and message thread view.
 * @component Chat
 */
      ...
      <div className="w-[300px] border-r border-gray-200 bg-[#F5EEF8] flex flex-col">
        ...
        <div className="overflow-y-auto flex-1">
          {chatList?.length > 0 ? (
            ...
            <div className="px-5 py-3 text-center text-gray-500 text-sm">No chats available</div>
          )}
        </div>
      </div>
        ...
        {selectedChat && selectedChatUser && conversationId ? (
          <>
            <div className="flex items-center gap-4 px-8 py-5 bg-white">
              ...
              <div>
                <h2 className="text-[17px] font-semibold">{selectedChatUser.name}</h2>
                <p className="text-green-500 text-sm flex items-center gap-1">● Online</p>
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isMe && showAvatar && (
                        <Image
                          src={
                            selectedChatUser.image || selectedChatUser.businessLogo || '/user.png'
                          }
                          width={32}
                          height={32}
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-2">Loading conversation...</h3>
            </div>
          </div>
        ) : selectedChat ? (
