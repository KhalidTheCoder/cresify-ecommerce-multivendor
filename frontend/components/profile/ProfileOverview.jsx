/**
 * @file ProfileOverview.jsx
 * @description Quick-stats overview cards in the user profile.
...
import { Camera, Mail, Phone, Calendar, MapPin, Edit, Trash2, KeyRound } from 'lucide-react';
    ...
    <div className="w-full bg-[#F7F7FA] pb-10 px-4 flex justify-center">
      ...
      <div className="w-full max-w-[900px]">
        ...
        <section className="bg-white rounded-[14px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] p-6 mb-6">
          <h2 className="text-[16px] font-semibold text-[#1B1B1B] mb-5">Profile Overview</h2>
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-[12px] text-[#9838E1] mt-[6px] cursor-pointer">Change Photo</p>
          </div>
        ...
        <section className="bg-white rounded-[14px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] p-6">
          <h3 className="text-[15px] font-semibold text-[#1B1B1B] mb-4">Security Settings</h3>
