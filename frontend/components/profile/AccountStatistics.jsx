/**
 * @file AccountStatistics.jsx
 * @description Detailed account statistics — orders, bookings, spend.
...
export default function AccountStatistics() {
  ...
  return (
    <div className="bg-white rounded-[12px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] p-5 w-full">
      {/* Title */}
      <h2 className="text-[16px] font-semibold text-[#1B1B1B] mb-4">Account Statistics</h2>
