/**
 * @file CartProductList.jsx
 * @description Cart item list with individual quantity controls and remove buttons.
  ...
  if (!groupedCartItems.length && !showCheckout && !orderSuccess) {
    return (
      <section className="w-full bg-[#F5F5FA] min-h-[60vh] flex flex-col items-center justify-center px-5 text-center">
        ...
        <h3 className="text-2xl font-semibold text-gray-800 mb-3">{t('cartEmpty')}</h3>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <step.icon
                        size={18}
                        className={`${
                          step.active || step.completed ? 'text-white' : 'text-[#7B7B7B]'
                        }`}
                      />
                    </div>
                    ...
                    <span
                      className={`
                        ...
                        ${step.active || step.completed ? 'text-[#1B1B1B]' : 'text-[#7B7B7B]'}
                      `}
                    >
                      {step.name}
                    </span>
        ...
        {!showCheckout && !orderSuccess && (
          <div className="max-w-[1300px] mx-auto">
            <div className="flex items-center justify-between mb-6">
              <h1 className="text-2xl font-bold text-gray-800">{t('yourCart')}</h1>
              <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="flex items-center justify-between text-sm text-gray-700 mb-4 pl-1">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      checked={selectedProducts.length === totalItemsCount && totalItemsCount > 0}
              ...
              <div className="bg-white rounded-xl shadow p-6 h-max sticky top-20">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-xs">
                            {t('quantity')}: <span className="font-medium">x{item.quantity}</span>
                          </p>
                        </div>
                      </div>
                ...
                {selectedItems.length === 0 && (
                  <div className="text-center py-4 text-gray-500">No items selected</div>
                )}
          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1.7fr)_minmax(0,0.9fr)]">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-[16px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] px-6 py-5">
                  ...
                  <div className="space-y-4 text-[12px]">
                    {/* Full name */}
                    <div>
                      <label className="block text-[#666] mb-[4px]">{t('fullName')}*</label>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div>
                        <label className="block text-[#666] mb-[4px]">{t('email')}*</label>
                        <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
                      ...
                      <div>
                        <label className="block text-[#666] mb-[4px]">{t('telephone')}*</label>
                        <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
                    ...
                    {/* Address */}
                    <div>
                      <label className="block text-[#666] mb-[4px]">{t('address')}*</label>
                      <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div>
                        <label className="block text-[#666] mb-[4px]">{t('country')}*</label>
                        <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
                          <MapPin className="h-4 w-4 text-[#C2B7EB]" />
                          <input
                            name="country"
                      ...
                      <div>
                        <label className="block text-[#666] mb-[4px]">{t('city')}*</label>
                        <div className="flex items-center gap-2 rounded-[8px] border border-[#E3E1ED] px-3 py-[9px] bg-white">
                          <MapPin className="h-4 w-4 text-[#C2B7EB]" />
                          <input
                            name="city"
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div>
                        <label className="block text-[#666] mb-[4px]">{t('stateProvince')}</label>
                        <input
                          name="state"
                      ...
                      <div>
                        <label className="block text-[#666] mb-[4px]">{t('postalCode')}</label>
                        <input
                          name="postalCode"
                ...
                <div className="bg-white rounded-[16px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] px-6 py-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-[14px] font-semibold text-[#222]">{t('paymentMethod')}</h3>
                  </div>
                      ...
                      <div className="flex items-center justify-between rounded-[9px] bg-[#FAF7FF] px-3 py-[9px]">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-[#9B51E0]">{t('visaMastercardAmex')}</p>
                          </div>
                        </div>
                  ...
                  <div className="space-y-3 text-[12px]">{/* Stripe note + checkbox */}</div>
                </div>
              </div>
              ...
              <aside className="bg-white rounded-[16px] border border-[#ECE6F7] shadow-[0_4px_20px_rgba(0,0,0,0.06)] px-6 py-5 h-fit sticky top-20">
                <h3 className="text-[14px] font-semibold text-[#222] mb-4">{t('orderSummary')}</h3>
                ...
                {selectedItems.length === 0 && (
                  <div className="text-center py-4 text-gray-400 text-sm">No items selected</div>
                )}
                ...
                <div className="flex items-center justify-center gap-2 mb-3">
                  ...
                  <p className="text-[11px] text-[#777]">{t('securePayment')}</p>
                </div>

                {/* Payment methods */}
                <div className="flex border-t border-[#F1ECF8] justify-center w-full">
                  <div className="pt-3">
                    <p className="text-[11px] text-[#999] mb-2">{t('acceptedPaymentMethods')}</p>
        ...
        {orderSuccess && (
          <div className="max-w-[900px] mx-auto">
            <div className="bg-white rounded-[20px] border border-[#ECE6F7] shadow-[0_4px_30px_rgba(0,0,0,0.08)] p-8 md:p-12 text-center">
              ...
              {/* Success Message */}
              <h1 className="text-3xl font-bold text-[#1B1B1B] mb-4">{t('orderConfirmed')}</h1>
              <p className="text-gray-600 text-lg mb-2">{t('thankYouPurchase')}</p>
              <p className="text-gray-500 mb-8">{t('orderSuccessMessage')}</p>

              {/* Order Summary */}
              <div className="bg-[#F9F7FF] rounded-[14px] p-6 mb-8 max-w-[500px] mx-auto">
                <h3 className="text-lg font-semibold text-[#1B1B1B] mb-4">{t('orderSummary')}</h3>
              ...
              <div className="mb-8">
                <p className="text-gray-600 mb-2">
                  {t('paymentMethod')}:{' '}
                  <span className="font-semibold capitalize">{t('creditDebitCard')}</span>
                </p>
              ...
              <div className="mt-10 pt-6 border-t border-gray-200">
                <p className="text-gray-500 text-sm">
                  {t('confirmationEmail')} <span className="font-medium">{checkoutData.email}</span>
                </p>
