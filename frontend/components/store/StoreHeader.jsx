/**
 * @file StoreHeader.jsx
 * @description Vendor store header with banner image, logo, store name and sales statistics.
  ...
  return (
    <section className="w-full py-16 relative bg-white">
      <div className="max-w-[750px] mx-auto text-center px-6">
        {/* Icon */}
        <div
          className="w-[70px] h-[70px] rounded-[16px] mx-auto mb-4
        ...
        {/* Title */}
        <h2 className="text-[28px] md:text-[30px] font-semibold text-[#111] mb-2">Mountain Hub</h2>

        {/* Description */}
        <p className="text-[13px] md:text-[14px] text-[#8F5EFF] leading-relaxed">
          Short details Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
