 ...
 * @description Product listing grid rendered on the individual vendor store page.
...
export default function StorePage() {
  ...
  const storeJoinDate = store?.createdAt
              ...
              <div className="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl">
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    {t('basedOnProducts')} {activeProducts.length} {t('products')}
                  </div>
                </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex bg-gray-100 p-1 rounded-xl">
                  ...
                  >
                    <FiGrid
                      className={`text-lg ${viewMode === 'grid' ? 'text-purple-600' : 'text-gray-500'}`}
                    />
                  </button>
                  <button
                  ...
                  >
                    <FiList
                      className={`text-lg ${viewMode === 'list' ? 'text-purple-600' : 'text-gray-500'}`}
                    />
                  </button>
                </div>
                    ...
                    <div key={product._id} className="group">
                      <article className="bg-white rounded-3xl p-5 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 flex flex-col h-full overflow-hidden">
                        ...
                        <div className="relative mb-5 overflow-hidden rounded-2xl">
                          ...
                          {/* Tag */}
                          <span
                            className={`absolute top-4 left-4 ${tag.color} text-white text-xs rounded-full px-3 py-1.5 font-medium shadow-lg`}
                          >
                            {tag.text}
                          </span>
                        </div>
                      ...
                      <article className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="relative w-full md:w-64 flex-shrink-0">
                            ...
                            <span
                              className={`absolute top-3 left-3 ${tag.color} text-white text-xs rounded-full px-3 py-1.5 font-medium shadow-md`}
                            >
                              {tag.text}
                            </span>
                          </div>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 mb-5">
                              ...
                              <span
                                className={`px-3 py-1 text-xs font-medium rounded-full ${product.stock > 10 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
                              >
                                {product.stock || 0} {t('inStock')}
                              </span>
                              {product.shippingCost > 0 && (
                ...
                <div className="mt-12">
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div className="text-sm text-gray-600">
                      ...
                      {totalActiveProducts} {t('products')}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-600">
                    {store?.phoneNumber || t('phoneNotProvided')}
                  </span>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="text-gray-600">
                  <span className="font-medium">{t('activeProducts')}:</span>{' '}
