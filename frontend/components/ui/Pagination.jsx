/**
 * @file Pagination.jsx
 * @description Reusable page-number pagination control for list and grid views.
...
export default function Pagination({ page = 0, setPage, limit = 10, total = 0, currentCount = 0 }) {
    ...
    <div className="px-6 py-6 border-t border-gray-200 bg-white">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="text-sm text-gray-600">
          ...
          <span className="font-semibold text-gray-900">{currentItems > 0 ? skip + 1 : 0}</span>{' '}
          {t('seller:productsPage.pagination.to')}{' '}
          <span className="font-semibold text-gray-900">{skip + currentItems}</span>{' '}
