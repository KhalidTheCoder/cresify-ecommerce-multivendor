/**
 * @file TopBar.jsx
 * @description Dashboard top bar with mobile menu toggle, user avatar and notification bell.
 * @component TopBar
 */
      ...
      <div className="flex items-center justify-between px-4 py-5">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex flex-col text-right">
            ...
            <span className="text-[11px] text-[#8C8CA1] capitalize">{data?.user?.role}</span>
          </div>
