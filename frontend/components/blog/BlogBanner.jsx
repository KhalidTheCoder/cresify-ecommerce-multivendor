/**
 * @file BlogBanner.jsx
 * @description Hero banner section for the blog listing page with title and description.
...
export default function BlogBanner() {
  ...
  const getImageSrc = () => {
    ...
    if (
      featuredBlog.img &&
      (featuredBlog.img.startsWith('http') || featuredBlog.img.startsWith('https'))
    ) {
