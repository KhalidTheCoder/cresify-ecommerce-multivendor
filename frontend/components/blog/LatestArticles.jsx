/**
 * @file LatestArticles.jsx
 * @description Grid of the most recent blog articles with cover image, title, date and excerpt.
...
export default function LatestArticles() {
  ...
  const getCategoryName = (category) => {
    ...
    return translatedCategory || category || t('blog:latestArticles.categoryAll');
  };
    ...
    return (
      <div className="bg-[#F5F5F7] pt-1 pb-10">
        <div className="max-w-7xl mx-auto mt-16">
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">{t('blog:latestArticles.noArticles')}</p>
          </div>
        </div>
      </div>
    );
                ...
                <div className="relative w-full h-60">
                  {!failedImages[blog._id] ? (
                    <Image
                      ...
                      unoptimized={
                        imageSrc.includes('cdn.example.com') || imageSrc.includes('placehold.co')
                      }
                    />
                  ) : (
