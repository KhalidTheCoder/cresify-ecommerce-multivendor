/**
 * @file Footer.jsx
 * @description Site-wide footer with four-column layout: brand, quick links, categories, and contact.
 * @component Footer
 */
    ...
    >
      <div className="max-w-[1350px] mx-auto px-4 md:px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-14">
        ...
        <div>
          ...
          <p className="text-[14px] text-[#444] leading-[22px] mb-6">{t('company_description')}</p>
        ...
        {/* COLUMN 2 — Navigation */}
        <div>
          <h4 className="text-[16px] font-semibold text-[#7A4ACF] mb-4">{t('navigation.title')}</h4>
        ...
        {/* COLUMN 3 — Resources */}
        <div>
          <h4 className="text-[16px] font-semibold text-[#7A4ACF] mb-4">{t('resources.title')}</h4>
        ...
        {/* COLUMN 4 — Contact */}
        <div>
          <h4 className="text-[16px] font-semibold text-[#7A4ACF] mb-4">{t('contact.title')}</h4>
      ...
      <div className="max-w-[1350px] mx-auto px-4 md:px-10">
        <p className="text-center text-[13px] text-[#7A4ACF] mt-6">{t('copyright')}</p>
      </div>
    </footer>
  );
}
