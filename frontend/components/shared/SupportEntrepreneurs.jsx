/**
 * @file SupportEntrepreneurs.jsx
 * @description Marketing section encouraging customers to support independent sellers on Cresify.
 * @component SupportEntrepreneurs
 */
