/**
 * @file ServiceCategories.jsx
 * @description Icon grid of service categories for quick filtering.
 * @component ServiceCategories
 */

'use client';

import { LayoutGrid, Wrench, Zap, Leaf, Paintbrush, PawPrint } from 'lucide-react';
  ...
  return (
    <section className="w-full py-16 bg-[#F5F5F7]">
      <div className="max-w-[1300px] mx-auto px-6 text-center">
        {/* Heading */}
        <h2 className="text-[36px] font-bold text-[#1A1A1A]">Service Categories</h2>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Title */}
                  <p className="mt-3 text-[15px] font-semibold text-[#1A1A1A]">{cat.title}</p>

                  {/* Providers */}
                  <p className="text-[12px] font-bold text-[#9A5BFF] mt-[3px]">{cat.providers}</p>
                </div>
