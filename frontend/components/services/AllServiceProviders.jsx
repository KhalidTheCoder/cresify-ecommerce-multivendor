/**
 * @file AllServiceProviders.jsx
 * @description Paginated grid of all available service providers.
    ...
    return (
      <section className="w-full py-10 px-5 bg-[#F5F5F7]">
        <div className="max-w-[1350px] mx-auto">
          <h2 className="text-[36px] px-4 font-bold text-[#1B1B1B] mb-6">{t('all_providers')}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-white rounded-[20px] p-[14px] animate-pulse">
  ...
  return (
    <section className="w-full py-10 px-5 bg-[#F5F5F7]">
      <div className="max-w-[1350px] mx-auto">
        {/* Header */}
        <div className="mb-8 px-4">
          <h2 className="text-[36px] font-bold text-[#1B1B1B] mb-2">{t('all_providers')}</h2>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center">
              ...
              <div className="flex items-center gap-2 w-full md:w-auto">
                ...
                >
                  ...
                  {hasURLParams && <option value="custom">{t('custom_url_filter')}</option>}
                  {!hasURLParams &&
            ...
            <div className="mb-6 p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-green-800">
                  {t('showing_providers_from')} {cityParam && <strong>{cityParam}</strong>}
          ...
          {filteredProviders.length === 0 ? (
            <div className="col-span-3 text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">
                {hasURLParams ? t('no_providers_in_location') : t('no_providers_found')}
              </h3>
                  ...
                  <div className="bg-white rounded-[20px] overflow-hidden p-3.5 hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center text-[14px] text-[#6A6A6A] mb-3">
                        {[...Array(5)].map((_, i) => (
                          <AiFillStar
                            key={i}
                            className={`text-[15px] ${i < 4 ? 'text-[#FFA534]' : 'text-[#E0E0E0]'}`}
                          />
                        ))}
                    ...
                    <div className="flex-shrink-0">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <p className="text-[12px] text-[#6B6B6B]">{t('starting_at')}</p>
          ...
          <div className="mt-12 px-4">
            <div className="bg-white rounded-xl p-4 shadow-sm">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-sm text-gray-600">
                  {t('showing')} {startIndex} {t('to')} {endIndex} {t('of')} {totalProviders}{' '}
                  {t('entries')}
                  {hasURLParams && ` ${t('in')} ${countryParam || regionParam || cityParam}`}
            ...
            <div className="mt-4 text-center text-sm text-gray-500">
              ...
              {hasURLParams && (
                <span className="ml-2 text-blue-600 font-medium">• {t('filtered_by_url')}</span>
              )}
