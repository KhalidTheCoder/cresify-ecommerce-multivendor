/**
 * @file ServiceDetails.jsx
 * @description Detailed service listing with provider info and booking CTA.
...
function ServiceDetailsPage() {
  ...
  const { data: timeslotsData } = useGetProviderTimeslotsQuery(datesData?.data?.[0]?._id || '', {
    ...
    return (
      <section className="w-full bg-[#F7F7FA] py-14 px-6 min-h-screen">
        <div className="max-w-[1300px] mx-auto text-center py-20">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mb-2">{t('error.title')}</h2>
      ...
      <div className="max-w-[1300px] mx-auto">
        ...
        <div className="mb-6">
          <nav className="flex text-sm text-gray-600">
            ...
            <Link href="/service-providers" className="hover:text-purple-600">
              {t('breadcrumb.service_providers')}
            </Link>
            <span className="mx-2">/</span>
          ...
          <div className="pt-2">
              ...
              <div className="flex items-center gap-2 mt-3">
                ...
                <p className="text-sm text-gray-700 ml-1">
                  ...
                  <span className="text-gray-500">
                    {' '}
                    ({reviewCount} {t('provider_info.reviews')})
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200">
                <p className="text-gray-700 leading-relaxed">
                  {provider.serviceDescription || provider.shopDescription || provider.category
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  {provider.serviceRedius && provider.serviceRedius > 0 && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">
                        {t('service_description.service_radius')}: {provider.serviceRedius}
                        {t('labels.km')}
                      </span>
                    </div>
                  )}
                  ...
                  {provider.slotDuration && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">
                        {t('service_description.slot_duration')}: {provider.slotDuration}{' '}
                        {t('labels.minutes')}
                      </span>
                    </div>
                  )}
              ...
              <div className="flex items-center justify-between bg-gradient-to-r from-purple-50 to-orange-50 rounded-xl p-5">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">
                    ...
                    <span className="text-lg text-gray-600">/{t('labels.hour')}</span>
                  </p>
                  <p className="text-sm text-gray-500 mt-1">
                    {t('service_description.transparent_pricing')} •{' '}
                    {t('service_description.no_hidden_fees')}
                  </p>
                </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-500 text-center">
                {t('provider_info.registered_on')}{' '}
                {new Date(provider.createdAt).toLocaleDateString()} •
                {t('provider_info.last_updated')}{' '}
