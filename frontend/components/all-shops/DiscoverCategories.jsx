/**
 * @file DiscoverCategories.jsx
 * @description Category discovery grid for browsing stores by product or service type.
 * @component DiscoverCategories
 */

'use client';

import { LuGrid2X2, LuShirt, LuCupSoda, LuMonitor, LuPaintbrush, LuDumbbell } from 'react-icons/lu';
  ...
  return (
    <section className="w-full py-14 bg-white">
      <div className="max-w-[1250px] mx-auto px-6 text-center">
        {/* Heading */}
        <h2 className="text-[32px] font-bold mb-2 text-[#1B1B1B]">Discover Categories</h2>
          ...
          {categories.map((cat, idx) => {
            ...
            return (
              <div key={idx} className="flex flex-col items-center text-center">
                ...
                >
                  <Icon className="text-[26px]" style={{ color: cat.iconColor }} />
                </div>

                {/* Label */}
                <p className="mt-3 text-[14px] text-[#333333] font-medium">{cat.title}</p>
