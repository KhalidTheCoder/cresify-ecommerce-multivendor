/**
 * @file CustomerReviews.jsx
 * @description Customer review list with star ratings, pagination and review submission form.
    ...
    return (
      <section className="w-full bg-[#F7F7FA] py-10 px-6">
        <div className="max-w-[1300px] mx-auto">
          <h2 className="text-[20px] font-semibold text-[#1B1B1B] mb-5">{t('customerReviews')}</h2>
      ...
      <div className="max-w-[1300px] mx-auto">
        ...
        {reviews.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-[14px] border border-[#ECE6F7] shadow-[0px_3px_15px_rgba(0,0,0,0.05)]">
            ...
            <p className="text-gray-500 max-w-md mx-auto">{t('beFirstToReview')}</p>
          </div>
        ) : (
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex items-center gap-3">
                    {r.user?.avatar ? (
                      ...
                      <div
                        className={`w-[38px] h-[38px] rounded-full flex items-center justify-center ${getAvatarColor(r.user?._id || 'default')}`}
                      >
                        <span className="font-semibold text-sm">{getUserInitials(r.user)}</span>
                      </div>
                    )}
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <p className="text-[12px] text-gray-500 mt-[1px]">{formatDate(r.createdAt)}</p>
                  </div>
                </div>
