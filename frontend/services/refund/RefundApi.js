/**
 * @file RefundApi.js
 * @description RTK Query API slice for refund request creation and status tracking.
 * @module services/refund/RefundApi
 */
...
export const RefundApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    adminRefund: builder.query({
      query: ({ page = 1, limit = 10 }) => `/admin/refund/?page=${page}&limit=${limit}`,
    }),
