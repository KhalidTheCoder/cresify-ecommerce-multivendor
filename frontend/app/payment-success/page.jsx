/**
 * @file page.jsx
 * @description Payment success page displayed after a successful Stripe payment redirect.
  ...
  return (
    <section className="w-full min-h-screen bg-[#F7F7FA] flex items-center justify-center px-4 py-10">
      <div className="bg-white rounded-2xl shadow-lg max-w-md w-full p-8 text-center">
        ...
        {/* Title */}
        <h1 className="text-2xl font-bold text-[#1B1B1B] mb-2">Payment Successful!</h1>
