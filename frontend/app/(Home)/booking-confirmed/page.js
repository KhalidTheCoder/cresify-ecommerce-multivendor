/**
 * @file page.js
 * @description Booking confirmation page shown after a successful service booking.
 * @module app/(Home)/booking-confirmed/page
 */
    ...
    <section className="w-full bg-[#F7F7FA] py-16 px-6 flex flex-col items-center">
      ...
      <div className="pt-[3px] rounded-t-[24px] rounded-b-[400px] bg-gradient-to-r from-[#9838E1] to-[#F68E44] mb-14">
        <div className="w-full max-w-[500px] bg-white rounded-[20px] border border-[#E9E5F4] shadow-[0_10px_40px_rgba(15,23,42,0.08)] px-10 py-12 text-center">
          ...
          <h2 className="text-[20px] font-semibold text-[#1B1B1B]">Booking Confirmed!</h2>
          <p className="text-[13px] text-[#777] mt-2">Your service has been successfully booked</p>
          ...
          <div>
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[12px] font-semibold text-[#1B1B1B]">Smart Electricians</p>
