      ...
      <div className="min-h-screen bg-[#F5F5F7] pt-24 pb-10 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-[20px] overflow-hidden p-8 border border-[#EAEAEA] text-center">
            ...
            <p className="text-gray-600 mb-6">{t('blog:details.notFound.description')}</p>
            <Link
              href="/blog"
    ...
    <div className="min-h-screen bg-[#F5F5F7] pt-24 pb-10 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-[20px] overflow-hidden p-6 border border-[#EAEAEA]">
          ...
          <div className="relative w-full h-96 mb-6">
            <Image
              ...
              unoptimized={
                getImageSrc().includes('cdn.example.com') || getImageSrc().includes('placehold.co')
              }
            />
          </div>
          ...
          {/* Title */}
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{singleBlog.title}</h1>
            ...
            <div className="text-gray-700 leading-relaxed space-y-4">
              {singleBlog.description ? (
                ...
                <p className="text-base md:text-lg">
                  {singleBlog.description || t('blog:common.placeholders.noContent')}
                </p>
              )}
            </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 mb-4">{t('blog:details.content.share')}</p>
