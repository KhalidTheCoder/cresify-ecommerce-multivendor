/**
 * @file page.js
 * @description Marketplace listing page with product search and infinite-scroll grid.
 * @module app/(Home)/marketplace/page
 */
  ...
  return (
    <div>
      <Suspense fallback={<div>Loading...</div>}>
        <SearchHero onSearch={(term) => setSearchTerm(term)} initialSearch={searchTerm} />
