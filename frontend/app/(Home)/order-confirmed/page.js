/**
 * @file page.js
 * @description Order confirmation page shown after a successful payment.
 * @module app/(Home)/order-confirmed/page
 */

'use client';

import { Check, Package, ShoppingBag, Truck, Home, PhoneCall, Mail } from 'lucide-react';
        ...
        <section className="mx-auto w-full max-w-[440px]">
          <div className="pt-[3px] rounded-t-[20px] rounded-b-[40px] bg-gradient-to-r from-[#9838E1] to-[#F68E44]">
            <div className="bg-white rounded-[20px] shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-[#E9E5F4] px-10 pt-10 pb-6 text-center">
              ...
              <h1 className="text-[20px] font-semibold text-[#262626] mb-2">Order Confirmed!</h1>

              <p className="text-[12px] leading-[18px] text-[#8B8B9A] mb-6">
                Thank you for your purchase. Your order has been placed successfully and is being
                processed.
                <br />
        ...
        <section className="w-full">
          <div className="bg-white rounded-[20px] shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-[#E9E5F4] px-8 py-7">
            <div className="flex items-start justify-between mb-5">
              <h2 className="text-[13px] font-semibold text-[#262626]">Order Summary</h2>
            ...
            <div className="grid grid-cols-[1.1fr_1.1fr] gap-10 text-[11px]">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between border-b border-[#F1ECF8] pb-2">
                  ...
                  <span className="text-[#5B5B6B]">Credit Card (Stripe)</span>
                </div>
              ...
              {/* RIGHT: items ordered */}
              <div>
                <p className="text-[11px] font-semibold text-[#262626] mb-3">Item Ordered</p>
                ...
                <div className="space-y-3 text-[11px]">
                  ...
                  <div className="flex items-center justify-between gap-3 border-b border-[#F1ECF8] pb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[#333] font-semibold">Handmade Ceramic Vase</p>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[#333] font-semibold">Organic Honey Set</p>
                ...
                <div className="mt-5 flex items-center justify-between text-[11px]">
                  ...
                  <span className="text-[#F78D25] font-semibold text-[13px]">$87.00</span>
                </div>
              </div>
            </div>
          </div>
                ...
                return (
                  <div key={step.label} className="flex flex-1 items-center">
                    <div className="flex flex-col items-center gap-1">
                      ...
                      >
                        <Icon className={step.active ? 'text-white' : 'text-[#9A9EB3]'} size={20} />
                      </div>
                      <span
                        className={
                          step.active ? 'text-[11px] text-[#262626]' : 'text-[11px] text-[#A0A3B5]'
                        }
                      >
                        {step.label}
                      </span>
        ...
        <section className="w-full flex flex-col items-center gap-5">
          ...
          <div className="w-full max-w-[480px] bg-white rounded-[14px] border border-[#E9E5F4] shadow-[0_8px_28px_rgba(0,0,0,0.05)] px-6 py-4 text-center">
            <p className="text-[11px] text-[#8B8B9A] mb-2">
              Need help? If you have any questions about your order, feel free to contact us.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-5 text-[11px] font-medium">
              ...
              <a href="tel:+11234567890" className="flex items-center gap-1 text-[#A26AF1]">
