    ...
    const totals = bookings.reduce(
      (acc, booking) => {
        ...
        return {
          ...
          completedPayments:
            acc.completedPayments + (payment.paymentStatus === 'completed' ? 1 : 0),
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">{t('paymentHistory.subtitle')}</p>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <div className="text-xs px-2 py-1 bg-blue-100 text-blue-700 rounded-full">
                    {paymentTotals?.totalBookings || 0} {t('paymentHistory.stats.bookings')}
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-xl shadow p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">{t('paymentHistory.stats.taxRate')}</p>
              </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center">
            <div className="flex flex-col md:flex-row gap-4 w-full lg:w-auto">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <option value="all">{t('paymentHistory.controls.filterAll')}</option>
                  <option value="today">{t('paymentHistory.controls.filterToday')}</option>
                  <option value="week">{t('paymentHistory.controls.filterWeek')}</option>
                  <option value="month">{t('paymentHistory.controls.filterMonth')}</option>
                  <option value="year">{t('paymentHistory.controls.filterYear')}</option>
                </select>
              </div>

              {/* Items Per Page */}
              <div className="flex items-center gap-3">
                <span className="text-sm text-gray-600">{t('paymentHistory.controls.show')}</span>
                <select
                  value={limit}
                  onChange={(e) => {
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                  {t('paymentHistory.table.id')}: #{booking._id?.slice(-8) || 'N/A'}
                                </p>
                            ...
                            <div className="space-y-2">
                              <div>
                                ...
                                <p className="text-xs text-gray-500">
                                  ...
                                  {booking.provider?.serviceCategory || 'General'}
                                </p>
                              </div>
        ...
        {paymentTotals && paymentTotals.totalBookings > 0 && (
          <div className="mt-8 bg-gradient-to-r from-gray-900 to-gray-800 rounded-xl shadow-lg p-6 text-white">
            <h3 className="text-xl font-semibold mb-6">{t('paymentHistory.summary.title')}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div>
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  >
                    {paymentTotals.completedPayments} {t('paymentHistory.table.paid')}
                  </div>
                  <div className="text-xs px-2 py-1 bg-yellow-900 text-yellow-300 rounded-full">
                    {paymentTotals.pendingPayments} {t('paymentHistory.table.processing')}
                  </div>
                </div>
              </div>
              ...
              <div>
                <p className="text-sm text-gray-300">{t('paymentHistory.summary.totalFees')}</p>
              ...
              <div>
                <p className="text-sm text-gray-300">{t('paymentHistory.summary.nextPayout')}</p>
                <p className="text-3xl font-bold text-blue-400 mt-2">
                  $
                  {paymentTotals.pendingPayments > 0
                    ? (
                        (paymentTotals.totalNetPayout / paymentTotals.totalBookings) *
                ...
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      ...
                      {paymentTotals.totalEarned > 0
                        ? (
                            (paymentTotals.totalNetPayout / paymentTotals.totalEarned) *
                            100
                          ).toFixed(1)
                        : '0'}
                      %)
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div
                      ...
                      style={{
                        width: `${
                          paymentTotals.totalEarned > 0
                            ? (paymentTotals.totalNetPayout / paymentTotals.totalEarned) * 100
                            : 0
                        }%`,
                      }}
                    />
                ...
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      ...
                      {paymentTotals.totalEarned > 0
                        ? (
                            (paymentTotals.totalCommission / paymentTotals.totalEarned) *
                            100
                          ).toFixed(1)
                        : '0'}
                      %)
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div
                      ...
                      style={{
                        width: `${
                          paymentTotals.totalEarned > 0
                            ? (paymentTotals.totalCommission / paymentTotals.totalEarned) * 100
                            : 0
                        }%`,
                      }}
                    />
                ...
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      ...
                      {paymentTotals.totalEarned > 0
                        ? ((paymentTotals.totalTax / paymentTotals.totalEarned) * 100).toFixed(1)
                        : '0'}
                      %)
                    </span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div
                      ...
                      style={{
                        width: `${
                          paymentTotals.totalEarned > 0
                            ? (paymentTotals.totalTax / paymentTotals.totalEarned) * 100
                            : 0
                        }%`,
                      }}
                    />
