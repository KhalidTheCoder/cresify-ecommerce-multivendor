...
export default function Services() {
  ...
  return (
    <div className="min-h-screen w-full px-2 pt-6">
      {/* Header */}
      <div>
        <h1 className="text-[26px] font-semibold text-gray-900">Product Management</h1>
            ...
            return (
              ...
              >
                <div className="bg-white border border-[#E5D8FF] rounded-xl p-5 relative shadow-sm cursor-pointer hover:shadow-md transition">
                  ...
                  <h3 className="mt-4 font-semibold text-gray-900 text-[17px]">{cat.name}</h3>

                  <p className="text-sm text-[#9C6BFF] mt-1">{cat.providers} Providers</p>
          ...
          <tbody>
            {products.map((item, idx) => (
              ...
              >
                ...
                {/* Price */}
                <td className="py-3 px-3 text-[#F88D25] font-medium">{item.price}</td>
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-white w-full max-w-md rounded-2xl p-6 shadow-lg relative">
            ...
            <label className="text-[14px] text-gray-700 font-medium">Category Name*</label>
            <input
              type="text"
