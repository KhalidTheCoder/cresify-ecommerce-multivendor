  ...
  return (
    <div className="px-4 md:px-8 py-6">
      ...
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-[24px] md:text-[26px] font-semibold text-gray-900">Electrical</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {providers.map((p, i) => (
          <div key={i} className="bg-white border border-[#E5D8FF] rounded-xl shadow-sm p-4">
            {/* Image */}
            ...
            <div className="mt-4">
              ...
              <p className="text-[22px] font-bold text-[#F88D25] leading-tight">{p.price}</p>
