/**
 * @file page.js
 * @description Admin orders overview page listing all platform orders.
 * @module app/dashboard/admin-dashboard/orders/page
 */
...
export default function Services() {
  ...
  return (
    <div className="min-h-screen w-full px-2 pt-6">
      {/* Header */}
      <div>
        <h1 className="text-[26px] font-semibold text-gray-900">Product Orders</h1>
