/**
 * @file page.js
 * @description Admin payment history page with full transaction audit log and filters.
 * @module app/dashboard/admin-dashboard/payment-history/page
 */
...
import { FiUsers, FiCheckCircle, FiClock, FiSearch, FiChevronDown } from 'react-icons/fi';
...
export default function Services() {
  ...
  return (
    <div className="min-h-screen w-full px-2 pt-6">
      {/* Header */}
      <div>
        <h1 className="text-[26px] font-semibold text-gray-900">Service Booking</h1>
        <p className="text-sm text-[#9C6BFF] mt-1">Manage all marketplace products</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
        ...
        <div className="bg-white border border-[#EFE8FF] rounded-2xl p-5">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-[17px] font-semibold text-gray-900">Total Revenue</h2>
        ...
        <div className="bg-white border border-[#EFE8FF] rounded-2xl p-5">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-[17px] font-semibold text-gray-900">Revenue Overview</h2>
          ...
          <tbody>
            {orders.map((item, idx) => (
              ...
              >
                ...
                {/* Amount */}
                <td className="py-4 px-4 font-medium text-[#F88D25]">{item.amount}</td>
