/**
 * @file page.js
 * @description Admin CMS content management page for blog article creation and publishing.
 * @module app/dashboard/admin-dashboard/content/page
 */
  ...
  return (
    <section className="w-full mt-6 px-3 md:px-0">
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-[24px] font-semibold text-gray-900">All Articles</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        {articles.map((article) => (
          ...
          >
            ...
            <p className="text-[13px] font-medium text-[#8A2BE2] mt-3">{article.category}</p>

            <h3 className="text-[18px] font-semibold text-gray-900 mt-1">{article.title}</h3>
      ...
      {/* ======================== EDIT ARTICLE MODAL ======================== */}
      {showEditModal && (
        <EditArticleModal article={selectedArticle} onClose={() => setShowEditModal(false)} />
      )}
    </section>
  );
}
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-white w-full max-w-2xl rounded-2xl p-6 shadow-lg relative">
        ...
        {/* Image Upload */}
        <label className="block text-[14px] text-gray-700 font-medium mb-2">Articles Image</label>
        ...
        <div className="border-2 border-dashed border-[#C4B5FD] rounded-xl py-10 text-center cursor-pointer">
          ...
          <p className="mt-2 text-gray-700 font-medium">Click to upload image</p>
    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-white w-full max-w-2xl rounded-2xl p-6 shadow-lg relative">
        ...
        <div className="w-full h-[200px] rounded-xl overflow-hidden relative">
          <Image src="/blog/blog2.jpg" fill className="object-cover" alt="Article Image" />
        </div>
