/**
 * @file page.js
 * @description Vendor dashboard home page displaying KPI overview and recent activity.
...
export default function DashboardPage() {
  ...
  return (
    <div className="px-2 pt-6">
      {/* ======= DASHBOARD HEADER ======= */}
      <div className="mb-6">
        <h1 className="text-lg md:text-2xl font-semibold text-gray-900">{t('dashboard.title')}</h1>
