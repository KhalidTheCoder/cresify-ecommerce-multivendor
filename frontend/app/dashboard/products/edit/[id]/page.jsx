...
export default function EditProductPage() {
  ...
  return (
    <div className="min-h-screen px-2 py-6 text-[#111827]">
      ...
      <p className="text-sm text-[#A78BFA] mt-1">Update product details for ID: {id?.slice(-8)}</p>
      ...
      <form onSubmit={handleUpdate}>
        ...
        <div className="mt-8 bg-white p-6 rounded-2xl border border-[#ECECEC] shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
            <div className="space-y-1">
              <label className="text-sm text-gray-700 font-medium">Stock Quantity*</label>
              <input
                type="number"
                name="stock"
          ...
          {/* Product Image */}
          <div className="space-y-1 mb-5">
            <label className="text-sm text-gray-700 font-medium">Product Image</label>
            <div
