  ...
  return (
    <div className="min-h-screen text-[#111827]">
      ...
      <div className="w-full px-2 pt-2">
        ...
        {/* Title */}
        <h1 className="text-2xl sm:text-[28px] font-semibold text-[#111827]">Add New Product</h1>
        ...
        <form onSubmit={publishHandler}>
          ...
          <section className="mt-6 bg-white rounded-2xl border border-[#F1F1F5] shadow-sm">
            <div className="px-4 sm:px-6 pt-4 sm:pt-5 pb-3 border-b border-[#F3F4F6]">
              <h2 className="text-sm sm:text-base font-semibold text-[#111827]">Product Image</h2>
            </div>

            <div className="px-4 sm:px-6 pb-6 sm:pb-7 pt-4">
              <div
                className={`border-2 border-dashed ${
                  formData.imagePreview ? 'border-[#10B981]' : 'border-[#E5E7EB]'
                ...
                onClick={() =>
                  !formData.imagePreview && document.getElementById('imageUpload').click()
                }
              >
                <input
                  type="file"
                ...
                {formData.imagePreview ? (
                  ...
                  <>
                    ...
                    <div className="space-y-1 text-xs sm:text-sm">
                      <p className="text-[#4B5563] font-medium">Click to upload or drag and drop</p>
                      <p className="text-[11px] sm:text-xs text-[#9CA3AF]">PNG, JPG up to 10MB</p>
                    </div>
                  </>
                )}
              </div>
