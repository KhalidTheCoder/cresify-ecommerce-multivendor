...
const Bookingpage = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    const statusText = status ? t(`booking.status.${status}`) : t('booking.status.unknown');
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t('booking.stats.totalBookings')}</p>
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t('booking.stats.pending')}</p>
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t('booking.stats.accepted')}</p>
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">{t('booking.stats.revenue')}</p>
                <p className="text-2xl font-bold text-purple-600">
                  $
                  {bookings
                    .reduce((sum, booking) => sum + (booking.provider?.hourlyRate || 0), 0)
                    .toFixed(2)}
                </p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow mb-6 p-4">
          <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
            <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
              ...
              {/* Items Per Page */}
              <div className="flex items-center gap-2">
                <span className="text-sm text-gray-600">{t('booking.filters.show')}:</span>
                <select
                  value={limit}
                  ...
                  filteredBookings.map((booking) => (
                    <tr key={booking._id} className="hover:bg-gray-50">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            <div className="text-sm text-gray-900 font-medium">
                              {booking.provider?.email || t('common.notAvailable')}
                            </div>
                            <div className="text-xs text-gray-500">
                              {booking.provider?.fullName || t('common.notAvailable')}
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        ...
                        <div className="text-xs text-gray-500">
                          {booking.customer?.fullName || t('common.notAvailable')}
                        </div>
                      </td>
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="text-xs text-gray-500">
                            {booking.paymentMethod?.charAt(0)?.toUpperCase() +
                              booking.paymentMethod?.slice(1) || t('common.notAvailable')}
                          </div>
                        </div>
                      </td>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <option value="pending">{t('booking.actions.setToPending')}</option>
                              <option value="accept">{t('booking.actions.setToAccepted')}</option>
                              <option value="reject">{t('booking.actions.setToRejected')}</option>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-sm text-gray-700">
                  {t('booking.pagination.showing', {
                    start: Math.min((currentPage - 1) * limit + 1, totalBookings),
                ...
                {['pending', 'accept', 'reject', 'completed', 'cancelled'].map((status) => {
                  ...
                  return (
                    <div key={status} className="flex items-center justify-between">
                      <span className="text-sm text-gray-600">{t(`booking.status.${status}`)}</span>
                      <div className="flex items-center gap-2">
