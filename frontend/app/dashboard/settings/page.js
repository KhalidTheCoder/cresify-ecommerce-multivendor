/**
 * @file page.js
 * @description Vendor settings page for account preferences and store configuration.
...
export default function AccountSettings() {
  ...
  return (
    <div className="w-full min-h-screen px-2 pt-6">
      ...
      <p className="text-[#9C6BFF] text-sm mt-1">{t('settings.accountSettings.subtitle')}</p>
        ...
        <form onSubmit={saveProfileChangesHandler}>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col">
              ...
              />
              <p className="text-xs text-gray-500 mt-1">{t('settings.profile.form.emailHint')}</p>
            </div>
        ...
        <form onSubmit={saveServiceChangesHandler}>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col">
              ...
              >
                <option value="">{t('settings.service.form.selectCategory')}</option>
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-300 outline-none transition bg-white"
              >
                <option value="">{t('settings.service.form.selectArea')}</option>
              ...
              <p className="text-xs text-gray-500 mt-1">{t('settings.service.form.areaHint')}</p>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-300 outline-none transition bg-white"
              >
                <option value="">{t('settings.service.form.selectRadius')}</option>
              ...
              <p className="text-xs text-gray-500 mt-1">{t('settings.service.form.radiusHint')}</p>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-300 outline-none transition bg-white"
              >
                <option value="">{t('settings.service.form.selectExperience')}</option>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700 grid grid-cols-1 md:grid-cols-2 gap-2">
                <p>
                  <span className="font-semibold">{t('settings.pricing.service')}:</span>{' '}
                  {profile?.data?.serviceName || t('common.notSet')}
                </p>
                <p>
                  <span className="font-semibold">{t('settings.pricing.category')}:</span>{' '}
                  {profile?.data?.serviceCategory || t('common.notSet')}
                </p>
                <p>
                  <span className="font-semibold">{t('settings.pricing.area')}:</span>{' '}
                  {profile?.data?.serviceArea || t('common.notSet')}
                </p>
                <p>
                  <span className="font-semibold">{t('settings.pricing.experience')}:</span>{' '}
                  {profile?.data?.yearsOfExperience || t('common.notSet')}
                </p>
                <p>
                  <span className="font-semibold">{t('settings.pricing.hourlyRate')}:</span> $
        ...
        <form onSubmit={updateHourlyRateHandler}>
          ...
          <div className="flex flex-col mb-6">
            ...
            <div className="flex justify-between mt-1">
              <p className="text-xs text-gray-500">{t('settings.pricing.form.hourlyRateHint')}</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex flex-col">
              ...
              <input
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-300 outline-none transition"
              />
              <p className="text-xs text-gray-500 mt-1">{t('settings.password.form.hint')}</p>
            </div>
