...
import { useGetAllServiceProvidersQuery, useUpdateProviderStatusMutation } from '@/feature/UserApi';
import {
  Search,
  Filter,
  User,
    ...
    try {
      ...
      switch (exportOptions.columns) {
        ...
        case 'contact':
          ...
          break;
        case 'service':
          columns = ['Name', 'Service Name', 'Category', 'Hourly Rate', 'Service Area'];
          break;
        case 'status':
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">{t('serviceProviders.loading.loading')}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">{t('serviceProviders.loading.error.message')}</p>
          <button
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-2">{t('serviceProviders.subtitle')}</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('serviceProviders.stats.totalProviders')}</p>
              <p className="text-3xl font-bold text-gray-800 mt-1">{totalProviders}</p>
            </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('serviceProviders.stats.active')}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('serviceProviders.stats.pending')}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('serviceProviders.stats.suspended')}</p>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6 shadow-sm">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <div className="relative">
              ...
              >
                <option value="all">{t('serviceProviders.filters.allCategories')}</option>
                <option value="home-garden">{t('serviceProviders.filters.homeGarden')}</option>
                <option value="electronics">{t('serviceProviders.filters.electronics')}</option>
                <option value="services">{t('serviceProviders.filters.services')}</option>
                <option value="sports">{t('serviceProviders.filters.sports')}</option>
                <option value="other">{t('serviceProviders.filters.other')}</option>
              </select>
              <Filter
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white border border-gray-300 rounded-xl py-3 px-4 pr-10 focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm"
              >
                <option value="all">{t('serviceProviders.filters.allStatus')}</option>
                <option value="active">{t('serviceProviders.filters.active')}</option>
                <option value="pending">{t('serviceProviders.filters.pending')}</option>
                <option value="suspend">{t('serviceProviders.filters.suspend')}</option>
              </select>
              <Shield
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none"
                size={20}
            ...
            >
              <option value="5">5 {t('serviceProviders.actions.perPage')}</option>
              <option value="10">10 {t('serviceProviders.actions.perPage')}</option>
              <option value="25">25 {t('serviceProviders.actions.perPage')}</option>
              <option value="50">50 {t('serviceProviders.actions.perPage')}</option>
            </select>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-gray-600">{t('serviceProviders.filters.status')}:</span>
          ...
          <div className="flex items-center gap-2 ml-4">
            <span className="text-sm text-gray-600">{t('serviceProviders.filters.category')}:</span>
            {['all', 'home-garden', 'electronics', 'services', 'sports', 'other'].map(
              (category) => (
                <button
                  key={category}
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                      <FileSpreadsheet
                        size={24}
                        className={
                          exportOptions.format === 'csv' ? 'text-blue-600' : 'text-gray-500'
                        }
                      />
                    ...
                    >
                      <FileText
                        size={24}
                        className={
                          exportOptions.format === 'pdf' ? 'text-red-600' : 'text-gray-500'
                        }
                      />
                    ...
                    >
                      <FileSpreadsheet
                        size={24}
                        className={
                          exportOptions.format === 'excel' ? 'text-green-600' : 'text-gray-500'
                        }
                      />
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      {
                        id: 'all',
                        label: t('serviceProviders.modals.exportOptions.allProviders'),
                      },
                      {
                        id: 'filtered',
                        label: t('serviceProviders.modals.exportOptions.filteredProviders', {
                          count: filteredProviders.length,
                        }),
                      },
                      {
                        id: 'selected',
                        label: t('serviceProviders.modals.exportOptions.selectedProviders'),
                      },
                    ].map((option) => (
                      <label
                        key={option.id}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      {
                        id: 'all',
                        label: t('serviceProviders.modals.exportOptions.allColumns'),
                      },
                      {
                        id: 'basic',
                        label: t('serviceProviders.modals.exportOptions.basicInfo'),
                      },
                      {
                        id: 'contact',
                        label: t('serviceProviders.modals.exportOptions.contactInfo'),
                      },
                      {
                        id: 'service',
                        label: t('serviceProviders.modals.exportOptions.serviceInfo'),
                      },
                      {
                        id: 'status',
                        label: t('serviceProviders.modals.exportOptions.statusInfo'),
                      },
                    ].map((option) => (
                      <label
                        key={option.id}
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {getStatusDisplay(statusToUpdate.currentStatus).toUpperCase()}
                    </span>
                  </div>
                </div>
