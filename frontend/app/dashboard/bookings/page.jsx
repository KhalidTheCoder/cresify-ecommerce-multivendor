    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">{t('bookings.loading.error.message')}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">{t('bookings.title')}</h1>
            <p className="text-gray-600 mt-2">{t('bookings.subtitle', { count: totalBookings })}</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('bookings.stats.totalBookings')}</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('bookings.stats.pending')}</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('bookings.stats.confirmed')}</p>
              <p className="text-2xl font-bold text-gray-800 mt-1">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-500 text-sm">{t('bookings.stats.revenue')}</p>
          ...
          <div className="flex gap-3">
            <div className="relative">
              ...
              >
                ...
                <option value="processing">{t('bookings.filters.processing')}</option>
                <option value="completed">{t('bookings.filters.completed')}</option>
                <option value="canceled">{t('bookings.filters.canceled')}</option>
              </select>
              <Filter
                  ...
                  <td className="py-4 px-6">
                    <div>
                      ...
                      <div className="text-xs text-gray-500 mt-1">
                        {booking.timeSlot?.duration} {t('bookings.table.duration')}
                      </div>
                    </div>
                  </td>
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <span className="capitalize">{getStatusDisplay(booking.status)}</span>
                      </div>
                    </div>
                  </td>
                  <td className="py-4 px-6">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-white border-b p-6 flex justify-between items-center z-10">
              <div>
                <h2 className="text-2xl font-bold text-gray-800">{t('bookings.modal.title')}</h2>
                <p className="text-gray-600">
                  {t('bookings.modal.bookingId', {
                    id: selectedBooking._id.substring(selectedBooking._id.length - 8).toUpperCase(),
                  })}
                </p>
              </div>
              <button
            ...
            <div className="p-6 space-y-6">
              {/* Status Banner */}
              <div
                className={`rounded-xl p-5 ${getStatusColor(selectedBooking.status).replace(
                  'border',
                  'bg',
                )}`}
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-600">{t('bookings.modal.totalAmount')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="border rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <User size={20} className="text-blue-600" />
                    <h4 className="font-bold text-gray-800">{t('bookings.modal.customerInfo')}</h4>
                  </div>
                ...
                <div className="border rounded-xl p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <User size={20} className="text-green-600" />
                    <h4 className="font-bold text-gray-800">{t('bookings.modal.providerInfo')}</h4>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <div className="h-12 w-12 rounded-full bg-green-100 flex items-center justify-center">
              ...
              <div className="border rounded-xl p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-bold text-gray-800">{t('bookings.modal.bookingDetails')}</h4>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border rounded-xl p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-bold text-gray-800">{t('bookings.modal.paymentInfo')}</h4>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
              ...
              <div className="border rounded-xl p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-bold text-gray-800">{t('bookings.modal.notesActions')}</h4>
                </div>
                <div className="space-y-4">
                  <textarea
