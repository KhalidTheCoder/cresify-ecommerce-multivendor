/**
 * @file page.js
 * @description Vendor analytics page with revenue trend, daily sales, and order status charts.
  ...
  return (
    <div className="w-full min-h-screen px-2 pt-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-[28px] font-semibold text-[#1D1D1F]">Analytics</h1>
          <p className="text-[#A78BFA] text-sm mt-1">Track your store performance and insights</p>
        </div>
