    ...
    <div className="min-h-screen px-2 pt-6 flex justify-center">
      <div className="w-full space-y-8">
        ...
        <div className="bg-white border border-[#EFE9FF] rounded-2xl shadow-sm p-6">
          <h2 className="text-[18px] font-semibold text-gray-900 mb-6">Basic Information</h2>

          {/* Profile Picture */}
          <div className="flex items-start gap-5 mb-6">
            <div className="relative w-20 h-20 rounded-full overflow-hidden">
              <Image src="/user3.png" alt="Profile" fill className="object-cover" />
            </div>
        ...
        <div className="bg-white border border-[#EFE9FF] rounded-2xl shadow-sm p-6">
          <h2 className="text-[18px] font-semibold text-gray-900 mb-6">Change Password</h2>
