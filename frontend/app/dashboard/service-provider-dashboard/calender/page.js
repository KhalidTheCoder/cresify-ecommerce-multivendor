...
export default function AvailabilityPage() {
  ...
  const handleCreateDate = async () => {
    ...
    try {
      ...
      toast.error(error?.data?.message || t('availability.errors.dateAddFailed'));
    } finally {
  ...
  const handleCreateTimeSlot = async () => {
    ...
    try {
      ...
      toast.error(error?.data?.message || t('availability.errors.timeSlotAddFailed'));
    } finally {
  ...
  const handleDeleteDate = async (dateId) => {
    ...
    try {
      ...
      toast.error(error?.data?.message || t('availability.errors.dateDeleteFailed'));
    } finally {
      setDeletingId(null);
    }
  };
  ...
  const handleDeleteTimeSlot = async (slotId) => {
    ...
    try {
      ...
      toast.error(error?.data?.message || t('availability.errors.timeSlotDeleteFailed'));
    } finally {
      setDeletingId(null);
    }
  };
      ...
      <div className="w-full max-w-6xl space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-[#EFE9FF] shadow-sm p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm font-medium text-gray-800">{formatMonthYear()}</div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#EFE9FF] shadow-sm p-6">
            ...
            {!selectedDateId ? (
              <div className="text-center py-10">
                ...
                <p className="text-gray-600 mb-2">{t('availability.timeSlots.noDateSelected')}</p>
              ...
              <>
                ...
                <div className="space-y-3 max-h-80 overflow-y-auto">
                  {timeslotsLoading ? (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className="text-center">
                            ...
                            <div className="text-xs text-gray-500">{t('availability.to')}</div>
                            <div className="text-sm font-medium text-gray-900">
                    ...
                    <div className="text-center py-10">
                      <div className="text-4xl mb-4">⏰</div>
                      <p className="text-gray-600 mb-2">{t('availability.timeSlots.noSlots')}</p>
                      <p className="text-sm text-gray-500">
        ...
        <div className="bg-white rounded-2xl border border-[#EFE9FF] shadow-sm p-6">
          ...
          {datesLoading ? (
            <div className="text-center py-8">
              <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-purple-600"></div>
              <p className="mt-2 text-sm text-gray-500">{t('availability.loading.dates')}</p>
            </div>
            ...
            <div className="text-center py-12 border-2 border-dashed border-gray-300 rounded-lg">
              <div className="text-4xl mb-4">📅</div>
              <p className="text-gray-600 mb-2">{t('availability.allDates.noDates')}</p>
              <p className="text-sm text-gray-500 mb-4">{t('availability.allDates.noDatesHint')}</p>
              <button
