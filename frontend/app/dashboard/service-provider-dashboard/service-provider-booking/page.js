...
export default function RequestsPage() {
  const tabs = ['New Requests', 'Upcoming', 'In Progress', 'Completed', 'Canceled'];
    ...
    <div className="bg-white rounded-xl border border-[#E6E6E6] shadow-sm px-6 py-5 flex items-start justify-between">
      <div className="flex flex-col gap-10">
        ...
        <div className="flex items-start gap-4 min-w-[250px]">
          {/* Profile Image */}
          <Image src="/user2.png" width={48} height={48} alt="user" className="rounded-full" />

          {/* Info */}
          <div className="flex flex-col">
            <div className="flex items-center gap-3">
              <h3 className="text-[16px] font-semibold text-gray-900">{req.name}</h3>
