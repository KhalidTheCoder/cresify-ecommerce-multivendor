/**
 * @file page.js
 * @description User login page with email and password form powered by NextAuth.
    ...
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl p-8 border border-[#EFE9FF]">
          ...
          <p className="text-sm text-center text-gray-500 mt-1">{t.subtitle}</p>
          ...
          {/* Create account */}
          <p className="text-center mt-8 text-sm text-gray-600">{t.newHere}</p>
