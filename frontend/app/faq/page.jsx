/**
 * @file page.jsx
 * @description Frequently asked questions page with accordion-style collapsible answers.
 * @module app/faq/page
 */
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F9F7FF] to-white">
      ...
      <div className="bg-gradient-to-r from-[#9838E1] to-[#F68E44] py-16 px-6">
        <div className="max-w-6xl mx-auto text-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">{t('meta.title')}</h1>
          <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto">{t('meta.description')}</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-xl font-bold text-gray-800">{categoryData.title}</h2>
                </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl border border-[#ECE6F7] shadow-sm">
            ...
            <h3 className="font-bold text-gray-800 mb-2">{t('quick_links.documentation.title')}</h3>
            <p className="text-gray-600 text-sm">{t('quick_links.documentation.description')}</p>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-[#ECE6F7] shadow-sm">
            ...
            <p className="text-gray-600 text-sm">{t('quick_links.video_tutorials.description')}</p>
          </div>
          <div className="bg-white p-6 rounded-2xl border border-[#ECE6F7] shadow-sm">
            <div className="w-8 h-8 bg-gradient-to-r from-[#9838E1] to-[#F68E44] rounded-lg flex items-center justify-center mb-4">
              <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <p className="text-gray-600 text-sm">{t('quick_links.community_forum.description')}</p>
          </div>
        </div>
      </div>
    </div>
