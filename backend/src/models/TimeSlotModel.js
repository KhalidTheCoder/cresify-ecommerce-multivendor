 ...
 * @description Mongoose schema and model for granular bookable time slots.
 * @module models/TimeSlotModel
 */
...
TimeSlotSchema.index({ availability: 1, startTime: 1, endTime: 1 }, { unique: true });
