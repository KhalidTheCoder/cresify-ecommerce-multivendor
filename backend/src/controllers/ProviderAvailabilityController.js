/**
 * @file ProviderAvailabilityController.js
 * @description HTTP request handlers for service-provider availability schedules and time-slot generation.
 * @module controllers/ProviderAvailabilityController
 */
